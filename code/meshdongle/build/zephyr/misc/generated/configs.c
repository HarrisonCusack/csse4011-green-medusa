...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_RX_SEG_MSG_COUNT, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0xC553);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x4011);
