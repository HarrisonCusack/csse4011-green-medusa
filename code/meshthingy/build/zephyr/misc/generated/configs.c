...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_THINGY52_NRF52832, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_VDD_PWR_CTRL_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CCS_VDD_PWR_CTRL_INIT_PRIORITY, 85);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_SX1509B, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_SX1509B_INIT_PRIORITY, 70);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_SX1509B_DEBOUNCE_TIME, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CCS811, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CCS811_DRIVE_MODE_1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CCS811_TRIGGER_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTS221, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTS221_TRIGGER_GLOBAL_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTS221_TRIGGER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MSG_CACHE_SIZE, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LOOPBACK_BUFS, 8);
