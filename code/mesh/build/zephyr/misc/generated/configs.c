...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 8000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_PROXY_FILTER_SIZE, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_DEBUG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_DEBUG_MODEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_SERIAL_INIT_PRIORITY, 51);
